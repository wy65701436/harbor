...
// SetMultiple ...
func (immc *MemoryCache) SetMultiple(pid int64, imcs []cache.IMCandidate) error {
	immc.mu.Lock()
	defer immc.mu.Unlock()
...
// Stat ...
func (immc *MemoryCache) Stat(pid int64, repository string, tag string) (bool, error) {
	immc.mu.RLock()
...
// Clear ...
func (immc *MemoryCache) Clear(pid int64, imc cache.IMCandidate) error {
	immc.mu.Lock()
	defer immc.mu.Unlock()
...
// Flush ...
func (immc *MemoryCache) Flush(pid int64) error {
	immc.mu.Lock()
	defer immc.mu.Unlock()
