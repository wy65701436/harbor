...
type DAO interface {
	// Create ...
	Create(ctx context.Context, n *models.NotificationJob) (int64, error)

	// Update ...
	Update(ctx context.Context, n *models.NotificationJob, props ...string) error

	// Get ...
	Get(ctx context.Context, id int64) (*models.NotificationJob, error)
	...
	GetLastTriggerJobsGroupByEventType(ctx context.Context, policyID int64) ([]*models.NotificationJob, error)
...
func (d *dao) Update(ctx context.Context, job *models.NotificationJob, props ...string) error {
	if job == nil {
...
func (d *dao) Create(ctx context.Context, job *models.NotificationJob) (int64, error) {
	if job == nil {
...
// Get ...
func (d *dao) Get(ctx context.Context, id int64) (*models.NotificationJob, error) {
	ormer, err := orm.FromContext(ctx)
	if err != nil {
		return nil, err
	}
...
func (d *dao) Count(ctx context.Context, query *q.Query) (int64, error) {
	...
	qs, err := orm.QuerySetter(ctx, &models.NotificationJob{}, query)
	if err != nil {
		return 0, err
	}
	return qs.Count()
...
// List ...
func (d *dao) List(ctx context.Context, query *q.Query) ([]*models.NotificationJob, error) {
...
func (d *dao) GetLastTriggerJobsGroupByEventType(ctx context.Context, policyID int64) ([]*models.NotificationJob, error) {
	ormer, err := orm.FromContext(ctx)
	if err != nil {
		return nil, err
	}
...
func (d *dao) Delete(ctx context.Context, id int64) error {
	...
	n, err := ormer.Delete(&models.NotificationJob{
		ID: id,
	})
	if err != nil {
		return err
