...
type Manager interface {
	...
	// ListRbacPolicies list RbacPolicy according to the query.
	ListRbacPolicies(ctx context.Context, query *q.Query) ([]*model.RbacPolicy, error)
...
func (m *manager) ListRbacPolicies(ctx context.Context, query *q.Query) ([]*model.RbacPolicy, error) {
