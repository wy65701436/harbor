...
type Operator interface {
	...
	GetDetails(content []byte) (*ChartVersionDetails, error)
...
// GetChartDetails parse the details from the provided content bytes
func (cho *ChartOperator) GetDetails(content []byte) (*ChartVersionDetails, error) {
...
func (cho *ChartOperator) GetData(content []byte) (*chart.Chart, error) {
