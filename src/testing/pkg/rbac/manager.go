...
// DeletePermissionByRole provides a mock function with given fields: ctx, role_type, role_id
func (_m *Manager) DeletePermissionByRole(ctx context.Context, role_type string, role_id int64) error {
	ret := _m.Called(ctx, role_type, role_id)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, int64) error); ok {
		r0 = rf(ctx, role_type, role_id)
	} else {
		r0 = ret.Error(0)
	}
...
// GetPermissionsByRole provides a mock function with given fields: ctx, role_type, role_id
func (_m *Manager) GetPermissionsByRole(ctx context.Context, role_type string, role_id int64) ([]*model.RolePermissions, error) {
	ret := _m.Called(ctx, role_type, role_id)
