...
func (_m *DAO) DeletePermissionByRole(ctx context.Context, role_type string, role_id int64) error {
...
func (_m *DAO) GetPermissionsByRole(ctx context.Context, role_type string, role_id int64) ([]*model.RolePermissions, error) {
	ret := _m.Called(ctx, role_type, role_id)
