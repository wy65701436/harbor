...
${ova_service_options}  --prop:auth_mode="db_auth" --prop:clair_db_password="Clair123" --prop:max_job_workers="3" --prop:harbor_admin_password=${ova_harbor_admin_password} --prop:db_password=${ova_harbor_db_password}
